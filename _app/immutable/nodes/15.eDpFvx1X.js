import"../chunks/DsnmJJEf.js";import{p as E,c as F,g as H,f,a as m,ae as B,b as _,s,d as e,ah as J,al as r,r as t}from"../chunks/0fFYzV8P.js";import{h as K}from"../chunks/CH9wqv7q.js";import{C as k}from"../chunks/DLH6NDhh.js";import{T as N,a as h,b as y}from"../chunks/W_IbeJrr.js";import{D as u}from"../chunks/Di-BhB3u.js";import{M as Y}from"../chunks/BxmaMiL6.js";import{T as j}from"../chunks/DCihEmWP.js";import{c as q}from"../chunks/BNZ5_uH1.js";var G=f("<!> <ol><li><p>Add the plugin to <code>vite.config.ts</code>:</p> <!></li> <li><p>Add TypeScript support in your <code>app.d.ts</code>:</p> <!></li> <li><p>Import the virtual module anywhere in your app:</p> <!> <p>Both exports match the programmatic <!> shape. See <!> for what flows through <code>diagnostics</code>.</p></li></ol> <p>If TypeScript reports <code>Cannot find module 'virtual:svelte-docinfo'</code>, ensure the <code>/// &lt;reference&gt;</code> line is in your <code>app.d.ts</code>.</p>",1),U=f(`<!> <p>All options are optional; the minimal call uses defaults (package.json exports discovery, glob
			...
			files and sends HMR updates as you edit.</p></section> <!> <!> <!> <!>`,1);function rs(C,P){E(P,!0);const L=q("vite-plugin");K("1v4ku2r",b=>{H(()=>{J.title="Vite plugin - svelte-docinfo"})}),N(C,{get tome(){return L},children:(b,ss)=>{var x=X(),w=m(x),$=e(w),S=s(e($));Y(S,{module_path:"vite.ts",children:(l,v)=>{r();var n=B("Vite plugin");_(l,n)},$$slots:{default:!0}});var O=s(S,2);k(O,{lang:"ts",inline:!0,dangerous_raw_html:`<span class="token_string">'virtual:svelte-docinfo'</span>`}),r(),t($),t(w);var D=s(w,2);h(D,{children:(l,v)=>{var n=G(),o=m(n);y(o,{text:"Setup"});var p=s(o,2),a=e(p),i=s(e(a),2);k(i,{lang:"ts",dangerous_raw_html:`<span class="token_special_keyword">import</span> <span class="token_punctuation">{</span>defineConfig<span class="token_punctuation">}</span> <span class="token_special_keyword">from</span> <span class="token_string">'vite'</span><span class="token_punctuation">;</span>
